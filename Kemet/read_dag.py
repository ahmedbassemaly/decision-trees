...
# graphs = pydot.graph_from_dot_file('D:\Ahmed Bassem\MIU\Year 4\Graduation Project\decision trees\D021.dot')
# graphFilename = graphs[0]
...
if __name__ == "__main__":
    n_nodes, p, comp_matrix, adj_matrix = read_dag(filename)
    print('No. of nodes: {}\nNo. pf processors: {}\nComputation Matrix:\n{}\nAdjacency Matrix:\n{}\n'.format(
